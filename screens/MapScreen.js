...
Mapbox.setAccessToken('pk.eyJ1IjoiaHlhY2ludGhlaCIsImEiOiJjanoxMGt3bGcwMnNvM2Rtd3BoemkzaHUzIn0.CK2odN1JME1C-6T92d3AIg');
const MAPBOX_KEY = "pk.eyJ1IjoiaHlhY2ludGhlaCIsImEiOiJjanoxMGt3bGcwMnNvM2Rtd3BoemkzaHUzIn0.CK2odN1JME1C-6T92d3AIg";
let MAPBOX_URL = ""; 
...
UNSAFE_componentWillMount(){
  ...
  buttonUpdate(actualPosition,watchIdRemove){
    if(actualPosition.timestamp !== 0){
      ...
      Geolocation.clearWatch(watchIdRemove);
